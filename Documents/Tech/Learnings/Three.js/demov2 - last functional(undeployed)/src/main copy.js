...
function pauseGame() {
    if (!gameStarted || isPaused || gameOverTriggered) return;
    isPaused = true;
...
// Distance and Progression Logic
const notifications = {
...
function switchToGameScene() {
    ...
    updateCameraPosition();
    updateModelSize();
    powerUpIntervalId = setInterval(createPowerUps, 10000); // Start power-ups here
    startObstacleCreation();
}
